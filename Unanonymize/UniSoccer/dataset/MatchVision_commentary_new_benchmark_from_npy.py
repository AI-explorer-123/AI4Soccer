...
class MatchVisionCommentary_new_benchmark_from_npy_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frames = torch.cat([self.transform(images=frame, return_tensors="pt")[
                           "pixel_values"] for frame in frames], dim=0)
        frames = rearrange(frames, 't c h w -> c t h w')

        caption = video_info['comments_text']
        anonymous_caption = video_info.get('comments_text_anonymized', '')
        ...
        return {
            ...
            "anonymous_caption_text": anonymous_caption
        }
    ...
    def collater(self, instances):
        ...
        batch["caption_text"] = [instance['caption_text']
                                 for instance in instances]
        batch["video_path"] = [instance['video_path']
                               for instance in instances]
        batch["anonymous_caption_text"] = [
            instance['anonymous_caption_text'] for instance in instances]
