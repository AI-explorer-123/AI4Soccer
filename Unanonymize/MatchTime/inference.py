...
if __name__ == "__main__":
    ...
    parser.add_argument("--feature_root", type=str, default="./features/features_CLIP")
    parser.add_argument("--ann_root", type=str, default="./dataset/MatchTime/valid/")
    ...
    parser.add_argument("--tokenizer_name", type=str, default="/home/jiayuanrao/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3-8B-Instruct", help="LLM checkpoints, use path in your computer is fine as well")
