...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_path', type=str, default="/remote-home/jiayuanrao/haokai/UniSoccer/train_data/video_clips/europe_uefa-champions-league_2016-2017/2016-11-01 - 22-45 Manchester City 3 - 1 Barcelona/2_28_18.mp4",
                        help='Path to the soccer game video clip.')
    parser.add_argument('--device', type=str, default="cuda:2", help='Device to extract.')
    ...
    parser.add_argument("--model_ckpt", type=str, default="./results/unanonymized_matchtime_aligned_time/checkpoints/model_save_best_val_CIDEr.pth", help="Model checkpoints, use path in your computer is fine as well")
